...
export class PrintPlugin {
  ...
  print(printWindowContext: {
    ...
    const iframeElement =
      // TODO forgot why ----
      //document.getElementById(this.settings.ids) ||
      printWindowContext.f
  ...
  generateBodyHtml() {
    ...
    this.mvElTable()
    return (
      "<body style='heigh:auto !important;overflow:visible !important;'>" +
      this.getPreparedElementHtml(this.elsdom) +
      '</body>'
    )
  }
  /**
