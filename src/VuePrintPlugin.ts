...
export class PrintPlugin {
   ...
   * @param {boolean} [options.preview=false] - Whether to show a print preview.
   * @param {string} [options.popTitle=''] - Title for the print window or preview.
   * @param {string} [options.extraHead] - Extra HTML content to add to the <head> of the print document.
   * @param {string} [options.extraCss] - Comma-separated list of CSS file URLs to include.
   * @param {number} [options.zIndex=20000] - z-index for the preview box.
   * @param {string} [options.previewTitle='Preview'] - Title for the preview box header.
   * @param {string} [options.previewPrintBtnLabel='Print'] - Label for the print button in the preview box.
   * @param {Function} [options.previewBeforeOpenCallback] - Callback before the preview is opened.
   * @param {Function} [options.previewOpenCallback] - Callback after the preview is opened.
   * @param {Function} [options.openCallback] - Callback after the print dialog is opened.
   * @param {Function} [options.closeCallback] - Callback after the print dialog is closed.
   * @param {Function} [options.beforeOpenCallback] - Callback before the print dialog is opened (for non-preview).
   * @param {object} [options.vue] - Vue instance, if used within a Vue environment.
   */
  constructor(options) {
   ...
   */
  loadPreviewIframe() {
    const previewBoxElement = document.getElementById('vue-print-nb-previewBox') // Corrected ID
   ...
   */
  preprocessElementForPrint(element) {
   ...
   */
  getPreparedElementHtml(processedClonedElement) {
  ...
  createOrGetPreviewBox() {
    ...
    printButtonElement.innerHTML = this.settings.previewPrintBtnLabel || 'Print'
...
export const VuePrintPlugin = {
   ...
   * @param {object} vnode - The virtual node (Vue 2).
   */
